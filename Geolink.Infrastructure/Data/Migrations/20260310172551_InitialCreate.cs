        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationRefreshTimingSeconds = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequireRegistration = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "UserSettingsHideFrom",
                columns: table => new
                {
                    HideFromId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserSettingsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSettingsHideFrom", x => new { x.HideFromId, x.UserSettingsId });
                    table.ForeignKey(
                        name: "FK_UserSettingsHideFrom_AspNetUsers_HideFromId",
                        column: x => x.HideFromId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSettingsHideFrom_UserSettings_UserSettingsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventSettings_StartsAt",
                table: "EventSettings",
                column: "StartsAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSettingsHideFrom_UserSettingsId",
                table: "UserSettingsHideFrom",
