...
public interface IFriendshipRepository : IRepository<Friendship>
{
    ...
    Task<IEnumerable<Friendship>> GetUserFriendsAsync(Guid userId, FriendshipStatus status = FriendshipStatus.Approved, CancellationToken cancellationToken = default);
